...
char& TString::operator[]( size_t n ) {
    if ( !ptr ) throw invalid_argument("pusty obiekt"); if ( n >= 0 && n < len ) return ptr[ n ];
    // co zrobić gdy n jest niepoprawne?
    // czy można np. napisać return '0'; ?
    // ponieważ zwracamy „przez referencję” więc
    // jedynym rozsądnym wyjściem jest „zgłosić wyjątek”
